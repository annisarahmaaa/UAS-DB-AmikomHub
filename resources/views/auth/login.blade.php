    ...
    <div class="max-w-md w-full glow-card-wrapper z-10 transition-all duration-500 hover:scale-[1.01]">
        ...
        <div class="futuristic-card rounded-[2.4rem] p-8 md:p-10">
            ...
            <form action="{{ route('admin.login.post') }}" method="POST" class="space-y-5">
                ...
                <button type="submit" 
                    class="w-full py-4 mt-3 bg-gradient-to-r from-indigo-600 to-indigo-700 text-white rounded-2xl font-bold text-sm tracking-wide shadow-lg shadow-indigo-600/20 hover:from-indigo-700 hover:to-indigo-800 focus:ring-4 focus:ring-indigo-500/20 outline-none transition-all duration-300 transform active:scale-[0.98]">
                    Masuk ke Dashboard
                </button>
            </form>
        </div>
