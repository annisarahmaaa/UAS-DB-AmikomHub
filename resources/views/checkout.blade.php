...
@section('content')
    <main class="max-w-3xl mx-auto px-6 py-20">
        <div class="mb-12">
            <a href="{{ url('/detail-event') }}" class="text-indigo-600 font-bold flex items-center gap-2 mb-6">
            ...
            <div class="bg-white rounded-3xl border border-slate-200 p-8 shadow-sm">
                ...
                <form class="space-y-6">
                    <div>
                        ...
                        <input id="namaLengkap" type="text" placeholder="Masukkan nama sesuai identitas" class="w-full px-5 py-4 bg-white border-2 border-slate-100 rounded-2xl focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-600 outline-none transition font-medium" required>
                    </div>
        ...
        <div class="bg-white w-full max-w-sm rounded-[2rem] overflow-hidden shadow-2xl animate-bounce-in">
            ...
            <div class="p-8 text-center">
                ...
                <div class="mt-8 space-y-4">
                    <button onclick="bayarGoPay()" class="w-full py-4 border-2 border-indigo-100 rounded-2xl flex justify-between items-center px-6 hover:border-indigo-600 transition group">
    ...
    <script>
        ...
        // Fungsi baru untuk menangkap nama dan memindah halaman
        function bayarGoPay() {
            ...
            window.location.href = "{{ url('/ticket') }}?nama=" + encodeURIComponent(nama);
        }
    </script>
