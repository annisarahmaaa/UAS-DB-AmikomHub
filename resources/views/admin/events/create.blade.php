    ...
    <div class="bg-white p-8 rounded-[2rem] border border-slate-100 shadow-sm">
        ...
        <form action="{{ route('admin.events.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div>
                ...
                <input type="text" name="title" value="{{ old('title') }}" placeholder="Contoh: Amikom Tech Talk 2026"
            ...
            <div>
                ...
                <textarea name="description" rows="4" placeholder="Tuliskan detail lengkap mengenai acara ini..."
                    class="w-full px-5 py-4 bg-slate-50 border-2 border-slate-100 rounded-2xl focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-600 outline-none transition font-semibold @error('description') border-red-400 @enderror">{{ old('description') }}</textarea>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="location" value="{{ old('location') }}" placeholder="Gedung / Link Meeting"
            ...
            <div>
                ...
                <div class="relative group">
                    <input type="file" name="poster" accept="image/*" 
                        class="w-full px-5 py-4 bg-slate-50 border-2 border-dashed border-slate-200 rounded-2xl group-hover:border-indigo-400 transition cursor-pointer">
                </div>
