...
@section('content')
    ...
    <div class="flex justify-between items-center mb-6">
        <div>
            <h2 class="text-2xl font-black">Kelola Event</h2>
            <p class="text-slate-500">Buat dan atur acara seru Anda di sini.</p>
        </div>
        <button class="bg-indigo-600 text-white px-6 py-3 rounded-xl font-bold hover:bg-indigo-700 transition shadow-lg shadow-indigo-100 active:scale-95">
            + Tambah Event Baru
        </button>
    </div>
